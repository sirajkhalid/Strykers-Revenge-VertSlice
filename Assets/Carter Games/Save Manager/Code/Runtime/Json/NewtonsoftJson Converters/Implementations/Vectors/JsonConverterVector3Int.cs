...
namespace CarterGames.Assets.SaveManager
{
    ...
    /// </summary>
    [Preserve]
    public sealed class JsonConverterVector3Int : SmJsonConverterBase<Vector3Int>
    {
        /* ─────────────────────────────────────────────────────────────────────────────────────────────────────────────
        |   Methods
        ───────────────────────────────────────────────────────────────────────────────────────────────────────────── */
        ...
        protected override void ReadFromJson(ref Vector3Int value, string name, JsonReader reader, JsonSerializer serializer)
        {
            switch (name)
            {
                case nameof(value.x):
                ...
                case nameof(value.y):
                    ...
                    break;
                case nameof(value.z):
                    value.z = reader.ReadAsInt32().GetValueOrDefault(0);
                    break;
            }
        }
        ...
        protected override IEnumerable<KeyValuePair<string, object>> WriteToJson(Vector3Int value, JsonSerializer serializer)
        {
